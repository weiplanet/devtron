...
import (
	...
	appstatecache "github.com/devtron-labs/devtron/util/cache/appstate"
	"github.com/devtron-labs/devtron/util/dex"
	httputil "github.com/devtron-labs/devtron/util/http"
...
type ClientApp struct {
	...
	settings *settings.OIDCSettings
...
func NewClientApp(settings *settings.OIDCSettings, cache OIDCStateStorage, dexServerAddr, baseHRef string) (*ClientApp, error) {
